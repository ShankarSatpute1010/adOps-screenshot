...
const Option10Content = ({
  ...
  useEffect(() => {
    if (selectSSOption.value == "Option 10") {
      ...
      setBrandTop(362);
      setSiteTop(300);
      setAllTopBatteryOptions(6);
      setAllRightBatteryOptions(30)
    }
  }, [imageTopSize, selectSSOption]);

  return (
    <div className="option-ten">
      <img
        style={{ width: "100%" }}
        src="https://demo.adgebra.in/custom/images/IRCTC-Screen5.jpg"
...
export default Option10Content;
