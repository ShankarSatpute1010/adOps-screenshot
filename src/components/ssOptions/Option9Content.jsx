...
const Option9Content = ({
  ...
  useEffect(() => {
    if (selectSSOption.value == "Option 9") {
      setImageTopSize(365);
      setTop(280);
      setBrandTop(363);
      setSiteTop(300);
      setAllTopBatteryOptions(27);
      setAllRightBatteryOptions(40)
    }
  }, [imageTopSize, selectSSOption]);

  return (
    <div className="option-nine">
      <img
        style={{ width: "100%" }}
        src="https://demo.adgebra.in/custom/images/IRCTC-Screen4.jpg"
